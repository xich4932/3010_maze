...
int main(){
    ...
    std::cout << ->get_names(); <<" earn " << user->get_points() << " points." << std::endl;
    std::cout << ->get_names(); <<" earn " << my_maze->getPlayer(1)->get_points() << " points." << std::endl;
    std::cout << ->get_names(); <<" earn " << my_maze->getPlayer(2)->get_points() << " points." << std::endl;
